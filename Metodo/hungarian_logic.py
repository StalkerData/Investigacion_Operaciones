...
class HungarianSolver:
    ...
    def resolver(matriz_original):
        ...
        pasos.append(
            {
                "matriz": matriz.copy(),
                "mensaje": "Matriz de costos inicial.",
                "lineas": None,
            }
        )
        ...
        pasos.append(
            {
                "matriz": matriz.copy(),
                "mensaje": "Paso 1: Restar el mínimo de cada fila.",
                "lineas": None,
            }
        )
        ...
        pasos.append(
            {
                "matriz": matriz.copy(),
                "mensaje": "Paso 2: Restar el mínimo de cada columna.",
                "lineas": None,
            }
        )
        ...
        while True:
            ...
            pasos.append(
                {
                    "matriz": matriz.copy(),
                    "mensaje": "Paso 4: Ajustar matriz (sumar/restar el mínimo no cubierto).",
                    "lineas": None,
                }
            )
